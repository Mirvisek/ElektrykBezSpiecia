                    ...
                    {activeTab === "seo" && (
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2 bg-slate-100 dark:bg-[#0D1A30] p-2 rounded-xl border border-slate-200 dark:border-slate-800 mb-8 sm:mb-12">
                                ...
                                <button type="button" onClick={() => setSubTab("seo", "openGraph")} className={`flex-1 min-w-[120px] px-4 py-3 rounded-lg font-bold transition-all ${activeSeoTab === "openGraph" ? "bg-white dark:bg-[#152744] shadow-sm text-brand-orange" : "text-slate-500 hover:text-slate-800 dark:hover:text-slate-300"}`}>Social Media (Open Graph)</button>
                                <button type="button" onClick={() => setSubTab("seo", "integrations")} className={`flex-1 min-w-[120px] px-4 py-3 rounded-lg font-bold transition-all ${activeSeoTab === "integrations" ? "bg-white dark:bg-[#152744] shadow-sm text-brand-orange" : "text-slate-500 hover:text-slate-800 dark:hover:text-slate-300"}`}>Integracje (Analytics / Pixel)</button>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-8">
                                ...
                                { id: "newsletter", label: "Newsletter", icon: <Users className="w-4 h-4" /> }].map(t => (
                                    <button key={t.id} onClick={() => setSubTab("mail", t.id)}
